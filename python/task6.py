...
def process_input():
    ...
    return instruction, baseinput, userinput

instruction, baseinput, userinput = process_input()

if instruction == "encrypt":
    Encrypt(baseinput, userinput)
else:
